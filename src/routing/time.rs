...
pub async fn game_clock_set_handler(Path(mins): Path<usize>) -> impl IntoResponse {
...
pub async fn countdown_clock_set_handler(Path(mins): Path<usize>) -> impl IntoResponse {
