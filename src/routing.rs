...
pub fn froggi_router(state: &AppState) -> Router {
    ...
    let auth_session_routes = Router::new()
        ...
        .route(
            "/game-clock/set-mins/:mins",
            post(game_clock_set_mins_handler),
        )
        .route(
            "/game-clock/set-secs/:secs",
            post(game_clock_set_secs_handler),
        )
        .route(
        ...
        .route(
            "/countdown-clock/set-mins/:mins",
            post(countdown_clock_set_mins_handler),
        )
        .route(
            "/countdown-clock/set-secs/:secs",
            post(countdown_clock_set_secs_handler),
        )
        .route(
        ...
        .route(
            "/teaminfo/download-preset/:id",
            get(teaminfo_download_preset_handler),
        )
        .route(
            "/teaminfo/import-preset",
            post(teaminfo_import_preset_handler),
        )
        .route(
            "/sponsors/upload",
    ...
    let app = Router::new()
        ...
        .route("/overlay.js", get(overlay_js_handler))
