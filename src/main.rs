...
lazy_static! {
    ...
    static ref OUT_OF_DATE: Arc<Mutex<bool>> = Arc::new(Mutex::new(false));
    static ref REMOTE_VERSION: Arc<Mutex<String>> = Arc::new(Mutex::new(String::from("0.0.0")));
}
...
async fn update_checker() -> Result<(bool, String)> {
